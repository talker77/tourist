...
$outgoingServerAddress      = 'smtp.yandex.com'; // Consult your hosting provider.
...
$sendingAccountUsername     = 'noreply@istanbultouristpass.com';
$sendingAccountPassword     = 'sootcimwwwozwuxh'; //Yandex password for apps

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'contact@istanbultouristpass.com'; // REQUIRED value.
$recipientName              = 'Istanbul Tourist Pass';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'Customer Service Message ' . date(YmdHisu); // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'ITP Contact Form';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'Europe/Istanbul';         // OPTIONAL, but some servers require this to be set.
