        ...
        <div class="container-fluid">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 Left">
                        <div class="row">
                            ...
                            <div class="Bx1 Buffer">
                                <p class="Grey ">3 QUIET WAY NORTH ROAD</p>
                                <p class="Grey ">RICHMOND TW9 4HB</p>
                                <p class="Grey ">+44 7496 256515 | info@alohaventures.com</p>
                            ...
                            <div class="Bx1 Buffer">
                                <p class="Blue ">TO</p>
                                <p class="Grey ">20.20 Limited</p>
                                <p class="Grey ">20-23 Mandela Street</p>
                                <p class="Grey ">+44 20 7383 7071  | info@20.20.co.uk</p>
                                <a href="www.alohaventures.com" target="_blank" class="Grey ">www.alohaventures.com</a>
                            </div>
                    ...
                    <div class="col-md-3 pull-right BufferMiddle">
                        <h1 class="Title ">INVOICE</h1>
                        <div class="BufferBig"></div>
                        <p class="Blue pull-right ">INVOICE #</p>
                        <p class="Grey pull-right ">10001 </p>


                        <p class="Blue pull-right  Buffer">DATE</p>
                        <p class="Grey pull-right ">May 4 ,2017</p>


                        <p class="Blue pull-right  Buffer">BALANCE DUE</p>
                        <p class="Grey pull-right Box ">May 4 ,2017</p>


                        <p class="Blue pull-right  Buffer">FOR</p>
                        <p class="Grey pull-right Box ">Arçelik Omni Project Consultancy</p>
