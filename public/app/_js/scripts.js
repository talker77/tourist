...
$(document).ready(function() {
    ...
    var itemsLength = $(".infinity-slider li").length;
    var itemsWidth = $(".infinity-slider li").width();

    var sliderWidth = parseInt(itemsLength)*parseInt(itemsWidth);
    $(".infinity-slider").width(sliderWidth);
    ...
    var $slideContainer = $(".infinity-slider");
    var $slides = $(".infinity-slider li");
    ...
    function startSlider() {
        interval =  setInterval(function() {
            $($slideContainer).animate({
                "margin-left": "-=" + width
            }, {duration: animationSpeed, easing: "linear" }, firstSlide);
        });
    ...
    $('.infinity-slider').hover(function() {
        stopSlider();
    }, function() {
        startSlider();
    });
